  ...
  return (
    <div className="space-y-3">
      <div className="overflow-x-auto rounded border border-gray-300 bg-white shadow-sm" style={{ WebkitOverflowScrolling: 'touch' }}>
        <table className="w-full border-collapse text-xs" style={{ minWidth: 620 }}>
          <thead>
          ...
          <tbody className="divide-y divide-gray-100">
            ...
            {items.length === 0 && (
              <tr>
                <td colSpan={6} className="text-center py-8 text-gray-400 italic text-sm border border-gray-200">
